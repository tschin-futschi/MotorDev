// =============================================================================
// @file    aw86008_strategy.h
// @brief   AW86008 烧录策略(Awinic)
//
// 烧录算法封装在 AwLocalIspStrategy 共用基类内(协议 0x32~0x37 本地 ISP 流程)。
// 本类只声明 IC 型号字串与描述;AW86008 / AW86100 共用同一份 STM32 端 ISP 驱动,
// UI 只通过 icModel() 区分。
// =============================================================================
#pragma once
...
class AW86008Strategy : public AwLocalIspStrategy {
public:
    AW86008Strategy(SerialManager *serialManager,
