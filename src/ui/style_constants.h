...
inline constexpr int SimulatorConnectionBarHeight = 36; ///< 模拟器顶部连接栏高度
...
inline constexpr int RegisterPopupButtonW = 96;       ///< 批量读写 / 块读取浮窗按钮宽度
...
// --- 示波器寄存器面板 ---
inline constexpr int ScopeRegPanelMinW = 430;              ///< 寄存器面板最小宽度
inline constexpr int ScopeRegPanelMinH = 292;              ///< 寄存器面板最小高度
inline constexpr int ScopeRegDescWidth = 124;              ///< 描述输入框宽度
inline constexpr int ScopeRegInputWidth = 92;              ///< 地址/值输入框宽度
inline constexpr int ScopeRegRowHeight = 24;               ///< 行控件高度（输入框 / 按钮）
inline constexpr int ScopeRegButtonWidth = 28;             ///< R/W 按钮宽度
inline constexpr int ScopeRegWindowInitW = 500;            ///< 寄存器读写浮窗初始宽度
inline constexpr int ScopeRegWindowInitH = 400;            ///< 寄存器读写浮窗初始高度
...
inline constexpr int FwFlashInfoFontPx = 11;           ///< 固件信息/日志/控制面板字号（px）

// --- 配置页面 ---
inline constexpr int ConfigFileButtonW = 120;          ///< Config File 行操作按钮宽度（浏览/写入/回填）
inline constexpr int ConfigFileButtonH = 32;           ///< Config File 行操作按钮高度
}
