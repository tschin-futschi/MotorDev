...
inline constexpr int ScopePlotFramePadding = 8;
inline constexpr int ScopePlotAxisLeft = 58;
inline constexpr int ScopePlotAxisTop = 14;
inline constexpr int ScopePlotAxisRight = 14;
inline constexpr int ScopePlotAxisBottom = 32;
inline constexpr int ScopePlotStackedGap = 10;
